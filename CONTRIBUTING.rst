...
Welcome to ``csd-py`` contributor's guide.
...
If you experience bugs or general issues with ``csd-py``, please have a look
...
You can help improve ``csd-py`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``csd-py`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``csd-py``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n csd-py python=3 six virtualenv pytest pytest-cov
    conda activate csd-py
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/csd-py.git
    cd csd-py
...
#. Install |pre-commit|_::
   ...
   ``csd-py`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/csd-py
.. _issue tracker: https://github.com/<USERNAME>/csd-py/issues
.. <-- end -->
